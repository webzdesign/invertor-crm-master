...
<div class="content pb-3">
    <form action="{{ route('task-status.update') }}" method="POST" id="cardForm" >
        @csrf
        <div class="d-flex align-items-center justify-content-between filterPanelbtn my-2 flex-wrap" style="display: flex!important;justify-content: flex-end!important;">
            ...
            <a href="{{ route('task-status.index') }}" class="btn-default f-500 f-14"> BACK </a>
        </div>
        ...
        <div class="d-flex overflow-auto pb-3 dragMain" id="sortable">
            ...
            <div class="card border-0 card-row card-secondary parent-card border-left-1p-solid-grey @if($status->is_static) disable-sorting @endif " data-mainstatus="{{ $status->id }}">
                ...
                <input type="hidden" name="sequence[]" value="{{ $status->id }}" @if($status->is_static) disabled @endif>
                ...
                <div class="card-body layover-container" style="padding: 0;" data-thisstatus="{{ $status->id }}">
                    @php
                        $trigger = \App\Models\CallTrigger::with(['nextstatus', 'currentstatus', 'user.roles'])
...
<script>
    var myModalEl = document.getElementById('trigger-options-modal')
