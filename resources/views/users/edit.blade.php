    ...
    <div class="cards">
        <div class="cardsBody pb-0">
            <div class="row">
                ...
                <div class="col-md-4 usernameDiv" style="display:{{ (in_array(6, $user->roles->pluck('id')->toArray())) ? 'block' : 'none' }};">
                    <div class="form-group">
                        <label class="c-gr f-500 f-16 w-100 mb-2">Username : <span class="text-danger">*</span></label>
                        <input {{ (in_array(6, $user->roles->pluck('id')->toArray())) ? 'readonly' : '' }} type="text" name="username" id="username" value="{{ old('username', $user->username) }}"
