                ...
                <div class="row">
                    ...
                    <div class="col-md-4 fieldDiv_4262" style="">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="order_number" placeholder="" type="text" value="{{ $po->order_no }}" readonly style="background:#ffffff">
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            let calculateAmount = (indexId = 0) => {
                ...
                if ($(`#product-${indexId}`).val() !== '' || $(`#product-${indexId}`).val() !== null) {
                    total = (parseFloat(price) * parseInt(quantity)) + parseFloat(expense);
                }
