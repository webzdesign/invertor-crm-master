...
@section('content')
    ...
    <form action="{{ route('information.store') }}" method="POST" id="addInformationPage" enctype="multipart/form-data">
        @csrf
        <div class="cards">
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-12">
                        <div class="form-group">
                            <label class="c-gr f-500 f-16 w-100 mb-2">Information Page Title : <span
                        ...
                        <div class="form-group">
                            <label class="c-gr f-500 f-16 w-100 mb-2">Information Page Url : <span
                                    class="text-danger">*</span></label>
                            <input type="text" readonly name="slug" id="slug" value="{{ old('slug') }}" class="form-control"
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <span class="banner-preview-mob position-relative" data-lang="{{ $lang }}">
                                        <span
                                            class="remove-banner-mob text-danger fw-bold align-items-center bg-danger rounded-circle ps-1 pe-1 position-absolute end-0 fs-2"
                                            style="cursor:pointer; z-index: 2; display:none;">
                                            <i class="fa fa-close fs-4" style="color: white;" aria-hidden="true"></i>
                                        </span>
                                        <img src="" alt="Preview" style="object-fit: cover;height:125px;"
