            ...
            <div class="row">
                <div class="col-md-4 col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="gift_title" id="gift_title" value="{{ old('gift_title', $gift->gift_title) }}" class="form-control"
                ...
                <div class="col-md-4 col-sm-12">
                    <div class="form-group">
                        <label class="c-gr f-500 f-16 w-100 mb-2" for="category_id">Category Name : <span
                    ...
                    <div class="form-group">
                        ...
                        @if (!empty($gift->gift_images) && file_exists(storage_path('app/public/gifts-images/' . $gift->gift_images)))
                            <span class="logo-preview position-relative">
                                <span
                                    class="remove-logo text-danger fw-bold align-items-center bg-danger rounded-circle ps-1 pe-1 position-absolute end-0"
                                    style="cursor:pointer; z-index: 2;display:;">
                                    <i class="fa fa-close fs-4" style="color: white;" aria-hidden="true"></i>
                                </span>
                                <img src="{{ asset('storage/gifts-images/' . $gift->gift_images) }}" alt="Preview"
