                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 mb-3 permission-listing">
                            <div class="PlBox">
                                @foreach($value as $k => $v)
                                    ...
                                    @endif
                                    <li class="form-check">
                                        <input type="checkbox" class="form-check-input permission @if($v->model == 'User') user-checked-box @endif @if($v->model == 'SalesOrder' && $v->slug=='sales-orders.accessfilter') access-filter-checked-box @endif" name="permission[]" id="{{ $v->id }}" value="{{ $v->id }}" aria-label="...">
                    ...
                    <div class="modal-body pb-3">
                        <div class="row" id="role-permission-content">
                            ...
                            @if(!empty($statuses))
                                ...
                                <li class="ml-2 form-check">
                                    <input type="checkbox" class="form-check-input order-status-filter-premission" name="access_order_status_id[]" id="access_order_status_id{{ $statusId }}" value="{{ $statusId }}" aria-label="..." >
